...
import LoadedPostDown from "./LoadedResponses/LoadedPostDown";
import styled from "styled-components";
import { device } from "./device";

const PostDown = (props) => {
  ...
  async function fetchPost() {
    ...
    const response = await fetch(
      `https://instagram-bulk-profile-scrapper.p.rapidapi.com/clients/api/ig/media_by_id?shortcode=${postId}&response_type=feeds&corsEnabled=false`,
      {
        method: "GET",
        headers: {
          "x-rapidapi-key":
    ...
    <>
      <section id="post-section">
        ...
        <div className="post-response">
          ...
          {hasLoaded && <LoadedPostDown responseObj={responseObj} />}
        </div>
      </section>
